   ...
   Example:
    #+begin_src lisp
      (repli '(a b c) 3)
       (A A A B B B C C C)
#+end_src
 * [[https://github.com/NF02/L-99Ninety-NineLispProblems/blob/main/src/p16.el][P16]] (**) Drop every N'th element from a list.
   Example:
    #+begin_src lisp
 ...
 * [[https://github.com/NF02/L-99Ninety-NineLispProblems/blob/main/src/p17.el][P17]] (*) Split a list into two parts; the length of the first part is given.
