...
#+email: ask at nfvblog at outlook dot it
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p07.el][P07]] (**) Flatten a nested list structure.
   Transform a list, possibly holding lists as elements into a `flat' list by replacing each list with its elements
   (recursively).
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p33.el][P33]] (*) Determine whether two positive integer numbers are coprime.
   ...
   #+begin_src lisp
     (coprime 35 64)
      T
    #+end_src
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p34.el][P34]] (**) Calculate Euler's totient function $\phi(m)$.
   ...
   Example: $m = 10: r = 1,3,7,9$; thus $\phi(m) = 4$. Note the special case: $\phi(1) = 1$.
    ...
    #+begin_src lisp
      (totient-phi 10)
       4
    #+end_src
    Find out what the value of $\phi(m)$ is if m is a prime number. Euler's totient function plays an
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p35.el][P35]] (**) Determine the prime factors of a given positive integer.
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p36.el][P36]] (**) Determine the prime factors of a given positive integer (2).
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p37.el][P37]] (**) Calculate Euler's totient function $\phi(m)$ (improved).
   See problem P34 for the definition of Euler's totient function. If the list of the prime
   factors of a number m is known in the form of problem P36 then the function $\phi(m)$ can be
   efficiently calculated as follows: Let $((p_1 m_1) (p_2 m_2) (p_3 m_3) \dots)$ be the list of prime
   factors (and their multiplicities) of a given number $m$. Then $\phi(m)$ can be calculated with
   the following formula:

   $\phi(m)=(p_1-1)*p_1**(m_1-1)*(p_2-1)*p_2**(m_2-1)*(p_3-1)*p_3**(m3-1)*\dots$
   or $\phi(m) = \prod_{i=1}^k (p_i - 1) \times p_i^{m_i - 1}$ or $\phi(m) = m \times \prod_{p_i \mid m} \left(1 - \frac{1}{p_i}\right)$

   Note that $a ** b$ stands for the b'th power of $a$.
 
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p38.el][P38]] (*) Compare the two methods of calculating Euler's totient function.
   Use the solutions of problems P34 and P37 to compare the algorithms. Take the number of basic
   operations, including CARs, CDRs, CONSes, and arithmetic operations, as a measure for efficiency.
   Try to calculate $\phi(1009^0)$ as an example.

 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p39.el][P39]] (*) A list of prime numbers.
   Given a range of integers by its lower and upper limit, construct a list of all prime numbers in
   that range.

 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p40.el][P40]] (**) Goldbach's conjecture.
   Goldbach's conjecture says that every positive even number greater than 2 is the sum of two
   prime numbers. Example: $28 = 5 + 23$. It is one of the most famous facts in number theory that has
   not been proved to be correct in the general case. It has been numerically confirmed up to very large
   numbers (/much larger than we can go with our Lisp system/). Write a function to find the two prime
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p41.el][P41]] (**) A list of Goldbach compositions.
   ...
   rarely, the primes are both bigger than say $50$. Try to find out how many such cases there are in the range $2\dots3000$.
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p46.el][P46]] (**) Truth tables for logical expressions.
   Define functions *and, or, nand, nor, xor, impl and equ* (for logical equivalence) which return the result of
   the respective operation on boolean values.

   A logical expression in two variables can then be written in prefix notation, as in the following
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p47.el][P47]] (*) Truth tables for logical expressions (2).
   Modify problem P46 by accepting expressions written in infix notation, with all parenthesis present. This allows
   us to write logical expression in a more natural way, as in the example: ~(A and (A or (not B)))~.
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p48.el][P48]] (**) Truth tables for logical expressions (3).
   Generalize problem P47 in such a way that the logical expression may contain any number of logical variables.
   Define table in a way that ~(table List Expr)~ prints the truth table for the expression Expr, which contains the
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p49.el][P49]] (**) Gray code.
   ...
   Can you apply the method of "result caching" in order to make the function more efficient, when it is to
   be used repeatedly?

 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p50.el][P50]] (***) Huffman code.
   First of all, consult a good book on discrete mathematics or algorithms for a detailed description of Huffman
   codes!
   
   We suppose a set of symbols with their frequencies, given as a list of (S F) elements. Example:
   ( (a 45) (b 13) (c 12) (d 16) (e 9) (f 5) ). Our objective is to construct a list of (S C) elements, where C
   is the Huffman code word for symbol S. In our example, the result could be
   ( (A "0") (B "101") (C "100") (D "111") (E "1101") (F "1100") ). The task shall be performed by a
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p54a,el][P54A]] (*) Check whether a given expression represents a binary tree
 ...
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p55.el][P55]] (**) Construct completely balanced binary trees
   In a completely balanced binary tree, the following property holds for every node: The number of nodes in its
   left subtree and the number of nodes in its right subtree are almost equal, which means their difference is not
   greater than one.

   Write a function cbal-tree to construct completely balanced binary trees for a given number of nodes. The function
   should generate all solutions. Put the symbol 'x' as information into all nodes of the tree.
   ...
   #+begin_src lisp
    ...
    #+end_src
 * [[https://raw.githubusercontent.com/NF02/L-99Ninety-NineLispProblems/refs/heads/main/src/p56.el][P56]] (**) Symmetric binary trees
   Let us call a binary tree symmetric if you can draw a vertical line through the root node and then the right
   subtree is the mirror image of the left subtree. Write a function symmetric to check whether a given binary tree
   is symmetric. We are only interested in the structure, not in the contents of the nodes.
